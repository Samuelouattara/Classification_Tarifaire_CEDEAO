-- ===================================================================
-- SCRIPT DE NETTOYAGE SIMPLE ET SÉCURISÉ
-- Version alternative sans problème de contraintes
-- ===================================================================
...
SELECT '✅ BASE DE DONNÉES NETTOYÉE ET RÉINITIALISÉE AVEC SUCCÈS!' as resultat;
...
SELECT '' as separator;
SELECT '========== PRODUITS CRÉÉS ==========' as section;
SELECT p.id_produit, 
...
SELECT '1️⃣ Testez: database/test-db.html' as etape_1;
SELECT '2️⃣ Classifiez: 1MILLION/classification-interface.html' as etape_2;
SELECT '3️⃣ Consultez: 1MILLION/historique-valide.html' as etape_3;

SELECT '' as separator;
SELECT '🎉 SYSTÈME PRÊT À L''UTILISATION!' as statut_final;
